    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin", "/adminLoginPage", "/admin/addEmployee", "/admin/allBookings", "/admin-login",  "/admin/customers", "/admin/allCustomers", "/admin/deleteEmp", "/admin/empForm", "/dashboard/bill", "/admin/empManagement", "/admin/roomManagement", "/admin/allEmployees", "/admin/getAllEmployees", "/admin/getAllRooms", "/admin/deleteEmployee", "/admin/getAllRoomTypes", "/admin/getAllBookings", "/getBill").permitAll()
